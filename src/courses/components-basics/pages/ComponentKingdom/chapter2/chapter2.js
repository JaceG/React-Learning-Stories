const ChapterTwo = ({
	...
	<div className='chapter'>
		<h2 className='chapter-title'>Chapter 2: Messages Between Workshops</h2>

		<div className='story-section'>
			<p className='story-paragraph'>
				For the Component Kingdom to function properly, workshops needed
				to communicate with each other. The master builder App would
				send special messengers carrying bags called{' '}
				<strong>Props</strong> to each workshop. These props contained
				all the specifications a workshop needed to create its piece.
			</p>
			...
			<p className='story-paragraph'>
				...
				determine exactly what to build and how it should behave. Props
				could contain any type of information - text, numbers,
		...
		<div className='interactive-section'>
			...
			<div className='instruction-box'>
				<p>
					<strong>
						👉 Click on different props in the messenger bag to see
						how they affect the Button component!
					</strong>
				</p>
			</div>
...
/>
		...
		<div className='lesson-insight'>
			...
			<p>
				Props are how components talk to each other. They're passed from
				parent to child, like arguments to a function. Props allow
				components to be flexible and reusable with different data and
				behaviors.
			</p>
		</div>
		...
		<div className='reflection-section'>
			...
			<p>
				How does the messenger metaphor help you understand how props
				work in React?
			</p>
			<p>
				Why is it important that props can carry different types of data
