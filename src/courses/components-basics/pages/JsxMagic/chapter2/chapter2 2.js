...
<p>Today is {formatDate(new Date())}</p>`}</pre>
								...
								{expressionType === 'function' && (
									<div className='playground-section'>
										<h4>
											Function Calls: Transforming data
...
<p>Capitalized: "{'adventurer'.charAt(0).toUpperCase() + 'adventurer'.slice(1)}"</p>`}</pre>
				...
				<div
					className='jsx-expressions-grid'
					style={{ marginTop: '30px' }}>
					<div
						className={`expression-card ${
							expressionType === 'text' ? 'active-card' : ''
						}`}
						...
						<p>
							Insert JavaScript variables or expressions as text
							content
						</p>
						{expressionType === 'function' && (
							<div className='playground-section'>
...
<p>Capitalized: "{'adventurer'.charAt(0).toUpperCase() + 'adventurer'.slice(1)}"</p>`}</pre>
					...
					<div
						className={`expression-card ${
							expressionType === 'attribute' ? 'active-card' : ''
						}`}
						...
						<p>
							Use expressions to set element attributes or props
							dynamically
						</p>
						{expressionType === 'function' && (
							<div className='playground-section'>
...
<p>Capitalized: "{'adventurer'.charAt(0).toUpperCase() + 'adventurer'.slice(1)}"</p>`}</pre>
					...
					<div
						className={`expression-card ${
							expressionType === 'function' ? 'active-card' : ''
						}`}
						...
						<p>
							Call functions to transform data before displaying
							it
						</p>
						{expressionType === 'function' && (
							<div className='playground-section'>
...
<p>Capitalized: "{'adventurer'.charAt(0).toUpperCase() + 'adventurer'.slice(1)}"</p>`}</pre>
					...
					<div
						className={`expression-card ${
							expressionType === 'array' ? 'active-card' : ''
						}`}
...
<li key={item.id}>{item.name}</li>
						...
						<p>Render lists of elements from arrays using map()</p>
						{expressionType === 'function' && (
							<div className='playground-section'>
								<h4>
									Function Calls: Transforming data with
...
<p>Capitalized: "{'adventurer'.charAt(0).toUpperCase() + 'adventurer'.slice(1)}"</p>`}</pre>
					...
					<div
						className={`expression-card ${
							expressionType === 'ternary' ? 'active-card' : ''
						}`}
...
: <LoginButton />
						...
						<p>
							Choose between different elements using ternary
							expressions
						</p>
						{expressionType === 'function' && (
							<div className='playground-section'>
...
<p>Capitalized: "{'adventurer'.charAt(0).toUpperCase() + 'adventurer'.slice(1)}"</p>`}</pre>
			...
			<div className='lesson-insight'>
				...
				<p>
					JSX allows you to embed any JavaScript expression within
					curly braces {}. This enables you to include dynamic values,
					call functions, render conditionally, and work with data
					directly in your component's markup. The ability to
					seamlessly mix JavaScript logic with UI structure is what
					makes React components so powerful and flexible.
				</p>
			</div>
		</div>
	);
