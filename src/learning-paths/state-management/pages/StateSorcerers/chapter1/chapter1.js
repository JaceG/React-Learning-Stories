...
const ChapterOne = () => {
	...
	return (
		<div className='chapter'>
			<ChapterIntro chapterNumber={1} title='The Memory Keepers' />
			...
			<StorySection
				paragraphs={[
					...
					<>
						...
						"I am <strong>Memnon</strong>, Chief of the State
			...
			<StorySection
				paragraphs={[
					<>
						...
						<strong>state</strong> - the magical ability for
					...
					<>
						...
						robes. "With this - the <strong>useState</strong> hook!
        ...
        Click me
			...
			<StorySection
				paragraphs={[
					<>
						...
						<strong>value</strong> (what you remember) and a{' '}
						<strong>setter</strong> (the spell to change that
			...
			<div className='interactive-section'>
				...
				<InstructionBox character='Memnon hands you a practice wand.'>
					"Now it's your turn, Aria. This counter will remember how
					many times you've cast the increment spell. Try it!"
				</InstructionBox>
...
Increment Count
			...
			<ChapterSummary
				characterIntros={[
					{
						name: `Memnon`,
						description: `Chief of the State Sorcerers in the Eastern Quarter, guardian of the crystal spires that pulse with living energy. His staff is topped with a constantly shifting orb of light containing memory orbs that represent state. "State is the soul of interactive components. It's what separates a static painting from a living, breathing entity. When you give a component state, you give it the power to remember, to learn, and to respond."`,
					},
				]}
				lessonInsight={{
