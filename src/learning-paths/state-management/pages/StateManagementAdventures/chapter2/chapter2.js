  ...
  ui: {
    ...
    soundEnabled: ${storeState.ui.soundEnabled ? 'true' : 'false'}
			...
			<div className='interactive-section'>
				...
				<InstructionBox character="Grand Reducer gestures to the control panels.">
      ...
      return {
        ...
        score: state.score + action.payload
			...
			<CodeExample
				...
				discoveredBy="The Redux Codex"
				code={`// Redux follows a strict architectural pattern
