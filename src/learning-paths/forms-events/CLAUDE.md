# Forms Events Learning Path - Formatting Issues

## Overview
This document lists all structural formatting issues found in the Forms Events learning path.
...
- Missing code-example: 12 occurrences
...
- Event types: `onClick`, `onChange`, `onSubmit`
