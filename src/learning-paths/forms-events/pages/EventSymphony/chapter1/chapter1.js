	...
	const content = (
		<>
			<div className='chapter'>
				...
				<StorySection
					paragraphs={[
						...
						<>
							<strong>Academy graduate Aria!</strong>
							{
				...
				<div className='aria-demonstrates'>
					...
					<p className='story-paragraph'>
						...
						"React doesn't just pass raw browser events - it wraps
						them in SyntheticEvents for consistency and performance.
				...
				<div className='concert-hall'>
					...
					<p className='conductor-instruction'>
						Conductor Eventus hands you the baton: "Try conducting
						these instruments to learn how React handles events!"
					</p>
						...
						{instruments.map((instrument) => (
							<div
								...
								className={`instrument ${instrument.type} ${
									playingInstruments.includes(instrument.name)
										? 'playing'
										: ''
								}`}
								onClick={() =>
			...
			<div className='aria-learns-synthetic'>
				...
				<p className='story-paragraph'>
					"The brilliance of React's event system," Eventus explained
					while Binary projected code examples, "is that it normalizes
					all browser differences. Just like a conductor ensures every
					musician plays in harmony, React ensures every event behaves
					consistently."
				</p>
      ...
      <p>Every event is orchestrated by React!</p>
			...
			<div className='interactive-section'>
				...
				<InstructionBox character='Conductor Eventus raises his baton.'>
					Help Aria learn how React orchestrates events by trying
					different interactions with the instruments above!
				</InstructionBox>
				...
				<div className='sheet-music'>
					...
					<ul>
						...
						<li>
							Type in the input below for onChange and onKeyPress
						</li>
				...
				<div className='event-worlds'>
					<div className='synthetic-world'>
						...
						<div className='aria-note'>
							"Like the hook patterns I learned - consistent and
							optimized!"
						</div>
					</div>
