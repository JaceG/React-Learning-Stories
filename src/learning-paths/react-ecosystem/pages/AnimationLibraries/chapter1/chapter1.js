		...
		<div className='chapter'>
			...
			<div className='code-section'>
				<div className='code-header'>
					<span className='code-title'>Animation Foundations in React</span>
				</div>
				<div className='code-example'>
					<pre>{`// Understanding Animation in React
...
// Hover effects
// Loading states
// Page transitions`}</pre>
				</div>
				<div className='code-tooltip'>
					<strong>Abbess Motia's Wisdom:</strong> "Native browser animations work 
					for simple cases, but React's component model creates unique challenges. 
					Animation libraries bridge this gap, providing declarative APIs that 
					work with React's mental model while handling performance optimization, 
					gesture integration, and complex orchestration. Master the fundamentals 
					first, then choose the right tool for your needs."
				</div>
			</div>
