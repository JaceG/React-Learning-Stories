		...
		<div className='chapter'>
			...
			<div className='code-section'>
				<div className='code-header'>
					<span className='code-title'>Choosing Your Styling Strategy</span>
				</div>
				<div className='code-example'>
					<pre>{`// Styling Strategy Decision Guide
  ...
  vanilla: {
    ...
    prepare: 'Stay updated with CSS specs'
				...
				<div className='code-tooltip'>
					<strong>Harmony Wisdom:</strong> "The styling debate ends not with a 
					winner, but with wisdom. Each approach evolved to solve real problems. 
					CSS Modules for safety, CSS-in-JS for component thinking, utilities for 
					speed, zero-runtime for performance. Choose based on your project's needs, 
					team's strengths, and performance requirements. The best developers can 
					work effectively with any approach."
				</div>
			</div>
