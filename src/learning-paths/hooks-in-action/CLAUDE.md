# Hooks In Action Learning Path - Formatting Issues

## Overview
This document lists all structural formatting issues found in the Hooks In Action learning path.
...
- Missing code-example: 6 occurrences
...
- Hook names: `useState`, `useEffect`, `useContext`, etc.
