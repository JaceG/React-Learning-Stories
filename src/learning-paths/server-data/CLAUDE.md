# Server Data Learning Path - Formatting Issues

## Overview
This document lists all structural formatting issues found in the Server Data learning path.
...
- Lesson insight heading not in correct format: "The [Something] Lesson:": 4 occurrences

## Technical Terms to Emphasize
Terms that should be wrapped in `<strong>` tags based on the learning path topic:
- Data fetching: `fetch`, `async/await`, `loading states`
